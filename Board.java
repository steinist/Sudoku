		...
		/*
		  private boolean solve(int k) {
            ...
            while(s is not Empty) {
              ...
              increment the counter of empty cell (k) as the possible_value failed to complete the sudoku in resonable time
    ...
    public void generate() {
		...
		/*
		  public void generate() {
            ...
            int times = 13; // This number is arbitary
            ...
            intitialize solution as a two dimension array of 9x9 size
		...
		*/
        ...
        for(int i = 0; i < board.length; i++){
            for (int j = 0; j < board[0].length; j++){
                solution[i][j] = board[i][j].getValue();
            }
        }
